...
def get_stopwords_list():
    ...
    additional_stopWords = ["0", "00", "000", "0パーセント", "0件", "0度", "0ユーロ", "0km", "0分", "0倍", "0ドル", "0メートル", "0mm", "0点", "00000", "の", "ら", "ころ", "および", "ap", "hp", "ド", "か月", "にも", "した", "では", "(", ")", "同国", "0回", "彼ら", "との", "しない", "ドニ", "hp", "ap", "eu", "世紀", "年", "月", "日", "時", "分", "秒", "メートル", "キロメートル", "センチメートル", "グラム", "キログラム", "リットル", "これ", "それ", "あれ", "ここ", "そこ", "あそこ", "どこ", "だれ", "何", "する", "いる", "ある", "なる", "こと", "もの"]
